# Deep Reinforcement Learning Drone Controller
...
This project uses a simulated environment called ROS Development Studio or [ROSDS](http://www.theconstructsim.com/rds-ros-development-studio/). ROS stands for Robot Operating System and it will be the primary communication mechanism between your agent and the simulation. 
...
- In case you run into an error after launching `rl_controller.launch` make sure that you set permissions for the entire directory to read, write and execute so:
...
Credits for this code go to [sksq96](https://github.com/sksq96/deep-rl-quadcopter). I've merely created a wrapper and updated some fixes to commonly known issues to help whoever wants to implement this project. 
